...
hms_msg *hms_msg_create() {
  ...
  INIT_LIST_HEAD( &msg->headers.lh );
  INIT_LIST_HEAD( &msg->named_headers.lh );
  msg->num_headers = 0;
...
int hms_msg_get_header_size( hms_msg *msg ) {
  ...
  /* header lengths */
  list_for_each_entry( uhdr, &msg->headers.lh, lh) {
  ...
  /* named headers */
  /* 1 for ":" and 1 for "\n" */
  list_for_each_entry( nhdr, &msg->named_headers.lh, lh) {
...
int hms_msg_destroy( hms_msg *msg ) {
  ...
  /* Delete headers */
  {
    ...
    list_for_each_entry_safe( hdr, next, &msg->headers.lh, lh) {
      list_del( &hdr->lh );
  ...
  /* Delete named headers */
  {
    ...
    list_for_each_entry_safe( hdr, next, &msg->named_headers.lh, lh) {
      list_del( &hdr->lh );
...
int hms_msg_set_verb(hms_msg *msg, char *verb ) {
  ...
  /* Check inputs */
  hms_assert_not_equals( __FILE__, __LINE__, (int) NULL, (int) msg );
  hms_assert_not_equals( __FILE__, __LINE__, (int) NULL, (int) verb );

  /* replaces existing verb */
  if( msg->verb ) { free( msg->verb ); msg->verb = NULL;}
  hms_assert_equals( __FILE__, __LINE__, (int) NULL, (int) msg->verb );

  /* add new verb */
  msg->verb = strdup( verb );
  hms_assert_not_equals( __FILE__, __LINE__, (int) NULL, (int) msg->verb );
...
int hms_msg_add_header(hms_msg *msg, char *value ) {
  ...
  /* Check inputs */
  hms_assert_not_equals( __FILE__, __LINE__, (int) NULL, (int) msg );
  hms_assert_not_equals( __FILE__, __LINE__, (int) NULL, (int) value );

  /* create header */
  hms_msg_uheader *hdr = __hms_create_header( value );
  
  /* add to list */
  list_add_tail( &hdr->lh, &msg->headers.lh );
  msg->num_headers++;
  return 0;
...
int hms_msg_get_header(hms_msg *msg, int index , char **value) {
  ...
  list_for_each_entry( hdr, &msg->headers.lh, lh) {
    if(i++ == index) break;
  }
...
int hms_msg_del_header(hms_msg *msg, int index ) {
  ...
  list_for_each_entry_safe(hdr, tmp, &msg->headers.lh, lh) {
    if( i++ == index) {
      list_del( &hdr->lh );
      __hms_destroy_header( hdr );
      msg->num_headers--;
...
int hms_msg_add_named_header( hms_msg *msg, char *key, char *value ) {
  ...
  /* Check input */
  hms_assert_not_equals( __FILE__, __LINE__, (int) NULL, (int) msg );
  hms_assert_not_equals( __FILE__, __LINE__, (int) NULL, (int) key );
  hms_assert_not_equals( __FILE__, __LINE__, (int) NULL, (int) value );
  ...
  hms_assert_not_equals( __FILE__, __LINE__, (int) NULL, (int) hdr );
  
  /* Add to list */
  list_add_tail( &hdr->lh, &msg->named_headers.lh);
  msg->num_named_headers++;
...
int hms_msg_get_named_header( hms_msg *msg, char *key, char **value ) {
  ...
  list_for_each_entry( hdr, &msg->named_headers.lh, lh) {
...
int hms_msg_del_named_header( hms_msg *msg, char *key ) {
  ...
  list_for_each_entry_safe(hdr, tmp, &msg->named_headers.lh, lh) {
...
int hms_msg_get_body( hms_msg *msg, char **data, int *len) {
  ...
  if( msg->content ) {
    ...
    *data = ( char *) malloc( msg->content_len );
    hms_assert_not_equals( __FILE__, __LINE__, (int) NULL, (int) *data );
...
int hms_msg_set_body( hms_msg *msg, char *data, int len ) {
  ...
  hms_assert_equals( __FILE__, __LINE__, (int) NULL, (int) msg->content );
  hms_assert_equals( __FILE__, __LINE__, (int) 0, (int) msg->content_len );

  /* Copy the data in and also add named header */
  msg->content = ( char * ) malloc( len );
  hms_assert_not_equals( __FILE__, __LINE__, (int) NULL, (int) msg->content );
...
static hms_msg_uheader* __hms_create_header( char * value ) {
  ...
  /* Check input */
  hms_assert_not_equals( __FILE__ , __LINE__ , 0, (int) value );  

  /* malloc space */
  hms_msg_uheader *hdr = calloc( 1, sizeof(hms_msg_uheader) );
  hms_assert_not_equals( __FILE__ , __LINE__ , 0, (int) hdr );
...
static int __hms_deinit_header( hms_msg_uheader *hdr ) {
  ...
  /* Check inputs */
  hms_assert_not_equals( __FILE__ , __LINE__ , 0, (int) hdr );  
  hms_assert_not_equals( __FILE__ , __LINE__ , 0, (int) hdr->val );  
...
static int __hms_destroy_header( hms_msg_uheader *hdr ) {
  ...
  hms_assert_not_equals( __FILE__ , __LINE__ , (int) NULL, (int) hdr );
  hms_assert_not_equals( __FILE__ , __LINE__ , (int) NULL, (int) hdr->val );
...
static int __hms_init_named_header( hms_msg_nheader *hdr, char *key, char *value ) {
  ...
  hms_assert_not_equals( __FILE__ , __LINE__ , (int) NULL, (int) hdr->key );
  hms_assert_not_equals( __FILE__ , __LINE__ , (int) NULL, (int) hdr->val );
...
static int __hms_deinit_named_header( hms_msg_nheader *hdr ) {
  ...
  /* Check inputs */
  hms_assert_not_equals( __FILE__ , __LINE__ , 0, (int) hdr );  
  hms_assert_not_equals( __FILE__ , __LINE__ , 0, (int) hdr->key );  
  hms_assert_not_equals( __FILE__ , __LINE__ , 0, (int) hdr->val );  
