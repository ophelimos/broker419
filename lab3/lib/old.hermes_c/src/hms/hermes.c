...
hms* hermes_init( int num_threads , int server_port, hms_ops ops ) {
  ...
  hms_assert_not_equals( __FILE__, __LINE__ , (int) NULL, (int) manager);
...
static void _hms_listen(hms *manager ) {
 ...
 retry_listen:
  ...
  while( HMS_TRUE ) {
    ...
    hms_assert_not_equals( __FILE__, __LINE__, (int) 0, (int) endpoint);    
...
int hms_endpoint_connect( char *hostname, int port ) {

  /* Check input */
  hms_assert_not_equals( __FILE__, __LINE__ , (int) NULL, (int) hostname);
...
hms_endpoint* hms_endpoint_init( int fd, hms_ops ops ) {
  ...
  hms_assert_not_equals( __FILE__, __LINE__ , (int) NULL, (int) endpoint);
